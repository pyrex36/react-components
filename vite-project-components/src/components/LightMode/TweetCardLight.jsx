...
const TweetCard = () => {
  return (
    <div className="font-['SF_Compact_Display_Medium'] font-bold max-w-xl mx-auto bg-white text-black p-4 rounded-md shadow-md">
      {/* User Info */}
      <div className="flex items-start gap-3">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-gray-700">@johndue</span>
            <span className="text-gray-700">· 23s</span>
          </div>
          <p className="mt-1 text-gray-800">Tom is in a big hurry.</p>
        </div>
      </div>
      {/* Tweet Image */}
      ...
      {/* Interaction Section */}
      <div className="flex items-center justify-between text-gray-600 text-sm mt-4 px-2">
