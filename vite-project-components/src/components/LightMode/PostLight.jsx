...
const Post = ({ profilePic }) => {
  return (
    <div className="font-['SF_Compact_Display_Medium'] font-bold max-w-md mx-auto bg-white text-black p-4 rounded-lg shadow-lg">
      <div className="flex items-start space-x-4">
        ...
        <div className="flex-1">
          <textarea
            className="w-full bg-gray-100 text-black p-2 rounded-lg resize-none"
