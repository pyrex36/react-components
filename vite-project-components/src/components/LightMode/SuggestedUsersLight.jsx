...
const SuggestedUsers = () => {
  ...
  return (
    <div className="font-['SF_Compact_Display_Medium'] font-bold bg-white text-black p-4 rounded-lg max-w-sm mx-auto">
      <div className="mb-4"> 
        <div className="relative">
          <input 
            ...
            className="w-full p-2 rounded bg-gray-200 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
      </div>
      <div className="mb-4">
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600">@alessandroveronezi</p>
          </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-600">@gabrielcantarin</p>
          </div>
          <button className="items-center bg-transparent ml-auto px-4 py-2 h-9 w-24 bg-blue-500 hover:bg-blue-500 text-white text-sm font-semibold hover:text-white border border-blue-500 rounded-full">
            Follow
          </button>
